...
impl Material {
    ...
    pub fn new(
        diffuse_name: Option<&str>,
        specular_name: Option<&str>,
        normal_name: Option<&str>,
        shininess: GLfloat,
    ) -> Material {
        Material::new_with_color(
            diffuse_name,
            specular_name,
            normal_name,
    ...
    pub fn from_images(
        diffuse: &Option<common::Image>,
        specular: &Option<common::Image>,
        normal: &Option<common::Image>,
        color: color::Color,
        shininess: GLfloat,
    ) -> Material {
